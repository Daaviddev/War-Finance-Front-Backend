...
contract Tank is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 TANK
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Tank Shares", "TANK") {
        _mint(msg.sender, 1 ether); // mint 1 GUN Share for initial pools deployment
