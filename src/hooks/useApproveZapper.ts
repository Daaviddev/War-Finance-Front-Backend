...
import {BNB_TICKER, GUN_TICKER, NUKE_TICKER, BTC_TICKER, ZAPPER_ROUTER_ADDR} from '../utils/constants';
...
function useApproveZapper(zappingToken: string): [ApprovalState, () => Promise<void>] {
  ...
  else if (zappingToken === BTC_TICKER) token = warFinance.externalTokens[BTC_TICKER];
