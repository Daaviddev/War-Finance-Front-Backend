      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <a
            ...
            <a
              href="https://twitter.com/war_finance"
              rel="noopener noreferrer"
              target="_blank"
            ...
            {/*<a href="https://github.com/Gunfi/contracts" rel="noopener noreferrer" target="_blank" className={classes.link}>
              <IconGithub style={{fill: '#fff', height: '20px'}} />
              </a>*/}
            <a href="https://discord.gg/aEqWszfaQS" rel="noopener noreferrer" target="_blank" className={classes.link}>
