...
<Page>
  <BackgroundImage />  
     <Grid item xs={12} md={12} lg={12} >     
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>Depending on the TWAP price of GUN there are different optimal strategies for protocol health. <br></br>All strategies can be found in our <a target={"_blank"} href="https://warfinance22.gitbook.io/warfinance/" >docs here.</a></p>
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>GUN TWAP: ${bondScale}</p>
