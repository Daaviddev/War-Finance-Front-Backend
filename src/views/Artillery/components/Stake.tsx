...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(warFinance.TANK, warFinance.contracts.Boardroom.address);

  const tokenBalance = useTokenBalance(warFinance.TANK);
        ...
        <CardContent>
          <StyledCardContentInner>
            <StyledCardHeader>
              ...
              <Label text={'TANK Staked'} color="#322f32" />
            </StyledCardHeader>
            <StyledCardActions>
