    ...
    <Switch>
      ...
      <Container>   
              <Grid item xs={12} md={12} lg={12} >     
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Start weekly GUN burns from the DAO ✅</p>   
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Tank governance voting through snapshot ✅</p>      
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Integrate weekly Tank raffle on site ✅</p>                  
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- NFT drop for LPs & TANK hodlers providing exclusive access to new developments</p> 
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Launchpad & partnerships with projects to give exclusive benefits for TANK holders ✅</p>
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Lending & borrowing of GUN & Tank on site</p>
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Implement cross chain GUN liquidity</p>
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Integrate GUN on large lending platforms as a stablecoin</p>
                  ...
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Dedicated mobile app for war finance</p>
                  <p style={{ fontSize: '20px', textAlign:'center', color: '#fff' }}>- Partner with crypto payment gateways to accept GUN</p>
